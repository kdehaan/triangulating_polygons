...
- Specific tests on functions such as the recursive backtracker
- Testing output on randomly generated valid polygons
- Comparing the test output to a brute force approach as validation
